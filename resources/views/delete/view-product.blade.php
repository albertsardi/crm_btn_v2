        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-8"> {{ $data->SubCategory ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                    <div class="col-4 text-right"> Brand </div>
                    <div class="col-8"> {{ $data->Brand ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                    <div class="col-4 text-right"> Barcode </div>
                    <div class="col-8"> {{ $data->Barcode ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-8"> {{ $data->MinStock ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                    <div class="col-4 text-right"> Stock Maximum </div>
                    <div class="col-8"> {{ $data->MaxStock ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                    <div class="col-4 text-right"> Stock Minimum Order </div>
                    <div class="col-8"> {{ $data->MinOrder ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-8"> {{ $data->UOM ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                    <div class="col-4 text-right"> Buy Price </div>
                    <div class="col-8"> {{ $data->BuyPrice ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                    <div class="col-4 text-right"> Sell Price </div>
                    <div class="col-8"> {{ $data->SellPrice ?? '-' }} </div>
                </div>
                <div class="row mb-1">
                    <div class="col-4 text-right"> HPP By </div>
                    <div class="col-8"> {{ $data->HppBy ?? '-' }} </div>
                </div>
                <hr/>
                <div class="row mb-1">
