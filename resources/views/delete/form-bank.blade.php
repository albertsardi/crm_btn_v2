...
@section('content')
    ...
    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div class="card mb-3">
            ...
            <div class="card-body">
                {{ Form::text('AccNo', 'Account #', ['placeholder'=>'ID']) }}
                {{ Form::text('BankAccNo', 'Bank Account #', ['placeholder'=>'ID']) }}
                {{ Form::text('BankAccName', 'Bank Account Name') }}
                {{ Form::text('BankId', 'Bank Name') }}
                {{ Form::select('BankType', 'Bank Type', $mBankType) }}
