...
@section('content')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            {{ Form2::select('PriceChannel', 'Price Channel', $mPriceChannel) }}
            <hr/>
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    Valid orders:
                    <span class="badge badge-success rounded">{{ $data->orderCount }}</span>
                    for a total amount of <span id="total-order-amount">Rp {{ $data->orderTotAmount }} </span>
                </div>
                <div class="col">
                    Invalid orders:
    ...
    <div class="card mb-3">
        <div class="card-header">
            <i class="fa fa-fw fa-map-marker"></i> Addresses <span class="badge badge-primary rounded">{{count($mAdrress)}}</span>
